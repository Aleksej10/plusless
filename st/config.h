...
static const char *colorname_old[] = {

  /* 8 normal colors */
  [0] = "#1d45bd", /* hard contrast: #1d2021 / soft contrast: #32302f */
  [1] = "#ff0044", /* red     */
  [2] = "#00ff80", /* green   */
  [3] = "#ffff00", /* yellow  */
  [4] = "#282828", /* blue    */
...
unsigned int const currentBg = 8, buffSize = 35536;
/// [Vim Browse] Colors for search results currently on screen.
unsigned int const highlightBg = 8, highlightFg = 15;
...
Glyph styleSearch = {' ', ATTR_BOLD, 15, 8};
Glyph style[] = {{' ', ATTR_BOLD ,15,8}, {' ',ATTR_BOLD,15,8},
                 {' ', ATTR_BOLD, 15, 8}, {' ', ATTR_BOLD, 15, 8}};
...
static Key key[] = {
	...
	{ XK_KP_Delete,     XK_ANY_MOD,     "\177",         0,    0},
	...
	{ XK_BackSpace,    ShiftMask,                      "\033C", 0,  0},
	...
	{ XK_greater,      Mod1Mask|ShiftMask,             "\033>",  0,  0},
	...
	{ XK_less,         Mod1Mask|ShiftMask,             "\033<",  0,  0},
